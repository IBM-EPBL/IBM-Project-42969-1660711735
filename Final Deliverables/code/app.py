...
def index():
    if request.method == 'POST':
        ...
        API_KEY = "p-03a6131d4957c0415bcf495eba18c26430a70d9c"
        ...
        response_scoring = requests.post(
            'https://eu-de.dataplatform.cloud.ibm.com/ml-runtime/spaces/e9502212-442a-4a2d-888e-4eb93f33993e/deployments?context=cpdaas#', 
